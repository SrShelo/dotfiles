...
config.bind('S',   'scroll-page 0 -0.75')
config.bind('gg', 'jseval --quiet window.scroll({top:0, behavior: "smooth"})')
config.bind('Z', 'scroll-page 0 0.75')
...
config.bind('<PgUp>',   'scroll-page 0 -0.75')
config.bind('<PgDown>', 'scroll-page 0 0.75')
...
config.bind('<Shift+<Tab>', 'tab-focus last', mode = 'insert')
...
config.bind('<Alt+d>Q', 'hint links tab-bg')
...
### Hint and yank the link to the clipboard
config.bind('<Alt+d>ya', 'hint all yank')
config.bind('<Alt+d>yi', 'hint images yank')
config.bind('<Alt+d>yl', 'hint links yank')
