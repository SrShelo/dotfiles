-- Modules
local layoutlist = require('config.vars.layoutlist') -- This module must be loaded before to be used, otherwise awesome will use the default config
...
beautiful.init(gears.filesystem.get_configuration_dir() .. "config/mytheme.lua")

-- This is used later as the default terminal and editor to run.
-- editor = os.getenv("EDITOR") or "nano"
-- editor_cmd = default.terminal   .. " -e " .. default.editor
...
-- beautiful.menu_font_size=50
-- mymainmenu = awful.menu({ items = { { "W Awesome", myawesomemenu },
--                                     { " Open Apps", openapps },
--                                     { " System", system }
--                                   }
--                         })
...
--     tagNames = {}
--     for i = 1, #tags.settings do
--         table.insert(tagNames, tags.settings[i].name)
--     end
...
-- awful.keygrabber {
--     keybindings = {
--         {{control         }, 'Tab', awful.client.focus.history.select_previous},
--         {{control, 'Shift'}, 'Tab', awful.client.focus.history.select_next    },
--     },
